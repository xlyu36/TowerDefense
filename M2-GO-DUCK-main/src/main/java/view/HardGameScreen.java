...
public class HardGameScreen {
                    ...
                    if (combatStarted) {
                        ...
                        for (int i = 0; i < enemyList.size(); i++) {
                            ...
                            if (enemy.getHealth() > 0 && enemy.getNode().isVisible()) {
                                ...
                                int marker = 0;
                                if (Math.abs(enemy.getLayoutX() - 312) < 1) {
                                    marker = 1;
                                }
                                if (Math.abs(enemy.getLayoutY() - 468.8) < 1) {
                                    marker = 0;
                                }
                                if (marker == 0) {
                                ...
                                if (Math.abs(enemy.getLayoutX() - 788) < 1
                                        && Math.abs(enemy.getLayoutY() - 468.8) < 1) {
    ...
    public HardGameScreen(int width, int length) {
        this.width = width;
        this.length = length;
        ...
        health = 8;
        healthLabel = new Label(health + "/8");
    ...
    public Scene getScene() {
        ...
        //Mid
        setPath(battlefield);
        battlefield.add(monument, 25, 15);
    ...
    private void setPath(GridPane battleField) {
        for (int row = 0; row <= numRow; row++) {
            for (int column = 0; column <= numColumn; column++) {
                ...
                } else if (column == 10 && row >= 5 && row <= 15) {
                    battleField.add(path, column, row);
                } else if (row == 15 && column <= 30 && column != 25) {
                    battleField.add(path, column, row);
                } else if (column == 31) {
                    battleField.add(path, column, row);
                } else if (row == 14 && column == 25) {
    ...
    private void moveEnemy() {
        ...
        for (int i = 0; i < enemyList.size(); i++) {
            ...
            while (!end) {
                ...
                } else if (Math.abs(x - 312) < 1 && y < 310.8) {
                    move.setFromY(y);
                ...
                } else if (x < 780 && Math.abs(y - 310.8) < 1) {
                    move.setFromX(x);
                    move.setToX(x + stepSize);
                    x += stepSize;
                    n.setLayoutX(n.getLayoutX() + stepSize);
                ...
                if (Math.abs(x - 780) < 1 && Math.abs(y - 310.8) < 1) {
                    end = true;
                }
